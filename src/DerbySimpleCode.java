...
public class DerbySimpleCode {
    ...
    public static String protocol = "jdbc:derby:/home/aleksey/HIT/Java/DerbySample/MyDB;create=false";
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            /*statement.execute(("CREATE TABLE Employees(employee_id int(9) PRIMARY KEY,first_name varchar(20) NOT NULL,last_name varchar(20) NOT NULL,city varchar(20) NOT NULL,address varchar(30),email varchar (30));"));
